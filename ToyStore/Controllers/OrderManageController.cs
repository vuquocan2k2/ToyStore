...
namespace ToyStore.Controllers
{
    ...
    public class OrderManageController : Controller
    {
        ...
        public ActionResult OrderApproval(int ID)
        {
            ...
            SentMail("Đơn hàng của bạn đã được duyệt", Email, "bangngo568@gmail.com", "kqwbxbmgrfyxsaev", "Vào đơn hàng của bạn để xem thông tin chi tiết");
        ...
        public ActionResult Delivered(int ID)
        {
            ...
            SentMail("Đơn hàng của bạn đã được giao cho đối tác vận chuyển", Email, "bangngo568@gmail.com", "kqwbxbmgrfyxsaev", "Vào đơn hàng của bạn để xem thông tin chi tiết. Sau khi nhận được đơn hàng, bạn vui lòng click vào link sau để xác nhận đã nhận được đơn hàng từ đơn vị vận chuyển: " + urlBase + "/OrderManage/Received/" + ID+"");
