...
namespace ToyStore.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult AddOrder(User user, int NumberDiscountPass = 0, string CodePass = "", string payment = "")
        {
            ...
            SentMail("Đặt hàng thành công", user.Email, "bangngo568@gmail.com", "kqwbxbmgrfyxsaev", "<p style=\"font-size:20px\">Cảm ơn bạn đã đặt hàng<br/>Mã đơn hàng của bạn là: " + order.ID);
